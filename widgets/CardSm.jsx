...
const CardSm = ({ image, title, price, cardDetail = false, onClick = () => false, key }) => {
  return (
    <>
      <div className="relative flex items-start gap-4 rounded-md overflow-hidden shadow-card-in p-3 bg-card" key={key}>
